...
# ── Jev-gated classification (conservative fallback) ─────────────────
from jev_decisions import classify_with_jev  # noqa: E402


def classify(X):
    """Classify a ticket via Jev Choice with fallback to the original."""
    return classify_with_jev(X, simple_classify)
